...
class DoctorInfoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            'DoctorData.nameEng' => 'required|string',
            'DoctorData.nameAra' => 'required|string',
            'DoctorData.educationEng' => 'required|string',
            'DoctorData.educationAra' => 'required|string',
            'DoctorData.noOfYearEng' => 'required|integer',
            'DoctorData.noOfYearAra' => 'required|integer',
            'DoctorData.contantEng' => 'required|string',
            'DoctorData.contentAra' => 'required|string',
            'DoctorData.availbiltyDay' => 'required|string',
            'DoctorData.filterDate' => 'required|string',
            'DoctorData.filterTime' => 'required|string',
